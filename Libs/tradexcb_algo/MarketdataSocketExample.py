...
API_KEY = "dff5240e819e9f14375872"
API_SECRET = "Ubhn282#vs"
source = "WEBAPI"
...
soc = MDSocket_io(set_marketDataToken, set_muserID,logger=True)

# Instruments for subscribing
Instruments = [{'exchangeSegment': 1, 'exchangeInstrumentID': 1594}
               ]
